# Adopt Server-Only Data Access Layer with Function-Based Repository Pattern: Data Access Operations
...
1. SHOULD: Data access operations SHOULD be organized by domain entity (e.g., field/, folder/, public-api/) within the server-only directory

## Policy Block

- SHOULD Data access operations SHOULD be organized by domain entity (e.g., field/, folder/, public-api/) within the server-only directory
