# Standardize tRPC Router Pattern for Primary Datastore Access: Trpc Router Procedures
...
1. MUST: All tRPC router procedures that access primary datastores MUST be implemented as separate, focused procedures with clear single responsibilities (e.g., find-attachments, get-envelope-field)

## Policy Block

- MUST All tRPC router procedures that access primary datastores MUST be implemented as separate, focused procedures with clear single responsibilities (e.g., find-attachments, get-envelope-field)
