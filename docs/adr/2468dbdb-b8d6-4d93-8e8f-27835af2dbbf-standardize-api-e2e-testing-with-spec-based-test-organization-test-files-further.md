# Standardize API E2E Testing with Spec-Based Test Organization: Test Files Further
...
1. MAY: Test files MAY be further organized into logical groupings within version directories if the number of endpoints grows significantly

## Policy Block

- MAY Test files MAY be further organized into logical groupings within version directories if the number of endpoints grows significantly
