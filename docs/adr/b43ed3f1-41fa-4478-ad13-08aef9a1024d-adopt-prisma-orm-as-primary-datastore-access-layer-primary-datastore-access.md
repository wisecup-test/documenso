# Adopt Prisma ORM as Primary Datastore Access Layer: Primary Datastore Access
...
1. MUST: All primary datastore access in tRPC server routers MUST use Prisma Client as the ORM layer

## Policy Block

- MUST All primary datastore access in tRPC server routers MUST use Prisma Client as the ORM layer
