# Adopt Server-Side Rendering with Loader Functions for Route-Level Data Fetching: Loader Functions Return
...
1. MUST: Loader functions MUST return appropriate HTTP status codes and handle errors gracefully with error boundaries

## Policy Block

- MUST Loader functions MUST return appropriate HTTP status codes and handle errors gracefully with error boundaries
