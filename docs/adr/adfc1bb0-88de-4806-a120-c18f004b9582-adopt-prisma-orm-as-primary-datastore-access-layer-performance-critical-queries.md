...
1. MAY: Performance-critical queries MAY use Prisma raw query methods ($queryRaw, $executeRaw) when type-safe query builder performance is insufficient

## Policy Block

- MAY Performance-critical queries MAY use Prisma raw query methods ($queryRaw, $executeRaw) when type-safe query builder performance is insufficient
