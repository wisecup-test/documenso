# Adopt Server-Only Data Access Layer with Transactional Boundaries: Server Only Data
...
1. MUST: Server-only data access modules MUST enforce authentication and authorization checks before executing database operations

## Policy Block

- MUST Server-only data access modules MUST enforce authentication and authorization checks before executing database operations
