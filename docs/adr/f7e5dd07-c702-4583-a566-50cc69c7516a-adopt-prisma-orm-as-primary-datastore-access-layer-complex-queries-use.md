# Adopt Prisma ORM as Primary Datastore Access Layer: Complex Queries Use
...
1. SHOULD: Complex queries SHOULD use Prisma's relation loading and filtering capabilities to minimize N+1 query problems

## Policy Block

- SHOULD Complex queries SHOULD use Prisma's relation loading and filtering capabilities to minimize N+1 query problems
