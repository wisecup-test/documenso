# Adopt E2E API Testing for Frontend Rendering Model Validation: Test Specifications Maintained
...
1. MUST: Test specifications MUST be maintained alongside API implementations and updated when API contracts change

## Policy Block

- MUST Test specifications MUST be maintained alongside API implementations and updated when API contracts change
