# Adopt Structured Logging with Observability Context in Data Access Operations: Data Access Logging
...
1. MUST: Data access logging MUST include correlation identifiers (request ID, user ID, organisation ID) to enable distributed tracing

## Policy Block

- MUST Data access logging MUST include correlation identifiers (request ID, user ID, organisation ID) to enable distributed tracing
