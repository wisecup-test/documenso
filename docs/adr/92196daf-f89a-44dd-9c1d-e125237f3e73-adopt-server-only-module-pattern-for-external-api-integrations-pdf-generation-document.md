# Adopt Server-Only Module Pattern for External API Integrations: Pdf Generation Document
...
1. MUST: PDF generation, document manipulation, and audit log rendering operations MUST be implemented as server-only modules

## Policy Block

- MUST PDF generation, document manipulation, and audit log rendering operations MUST be implemented as server-only modules
