# Adopt Server-Only Module Pattern for External API Integrations: External Integrations Implemented
...
1. MUST: All external API integrations MUST be implemented in modules explicitly marked as server-only and placed under designated server-only directory structures

## Policy Block

- MUST All external API integrations MUST be implemented in modules explicitly marked as server-only and placed under designated server-only directory structures
