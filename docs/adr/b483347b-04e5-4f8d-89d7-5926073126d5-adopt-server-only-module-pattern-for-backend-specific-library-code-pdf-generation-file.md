# Adopt Server-Only Module Pattern for Backend-Specific Library Code: Pdf Generation File
...
1. SHOULD: PDF generation, file processing, and document manipulation logic SHOULD be isolated in server-only modules

## Policy Block

- SHOULD PDF generation, file processing, and document manipulation logic SHOULD be isolated in server-only modules
