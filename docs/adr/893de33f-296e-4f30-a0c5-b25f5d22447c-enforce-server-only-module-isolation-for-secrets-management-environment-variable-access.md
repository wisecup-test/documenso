# Enforce Server-Only Module Isolation for Secrets Management: Environment Variable Access
...
1. SHOULD: Environment variable access patterns SHOULD be centralized in dedicated configuration modules within server-only boundaries

## Policy Block

- SHOULD Environment variable access patterns SHOULD be centralized in dedicated configuration modules within server-only boundaries
