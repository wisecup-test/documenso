# Standardize API Testing with E2E Test Specifications for Service Endpoints: E2e Tests Cover
...
1. SHOULD: E2E API tests SHOULD cover both success and failure scenarios including edge cases and error conditions

## Policy Block

- SHOULD E2E API tests SHOULD cover both success and failure scenarios including edge cases and error conditions
