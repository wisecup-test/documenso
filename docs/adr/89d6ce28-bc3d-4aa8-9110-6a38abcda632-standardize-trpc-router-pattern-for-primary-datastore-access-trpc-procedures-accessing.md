# Standardize tRPC Router Pattern for Primary Datastore Access: Trpc Procedures Accessing
...
1. MUST: All tRPC procedures accessing primary datastores MUST use TypeScript types derived from the datastore schema to ensure type safety across the API boundary

## Policy Block

- MUST All tRPC procedures accessing primary datastores MUST use TypeScript types derived from the datastore schema to ensure type safety across the API boundary
