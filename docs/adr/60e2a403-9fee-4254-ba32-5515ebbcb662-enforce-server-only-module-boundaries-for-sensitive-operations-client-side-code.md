# Enforce Server-Only Module Boundaries for Sensitive Operations: Client Side Code
...
1. MUST_NOT: Client-side code MUST NOT directly import or invoke server-only modules; all access MUST occur through defined API boundaries

## Policy Block

- MUST_NOT Client-side code MUST NOT directly import or invoke server-only modules; all access MUST occur through defined API boundaries
