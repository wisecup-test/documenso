# Adopt Prisma ORM as Primary Datastore Access Layer: Database Queries Use
...
1. MUST: All database queries MUST use Prisma's generated TypeScript types to ensure compile-time type safety

## Policy Block

- MUST All database queries MUST use Prisma's generated TypeScript types to ensure compile-time type safety
