# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Index Routes Use
...
1. MUST: Index routes MUST use the _index.tsx suffix to indicate default route behavior within a segment

## Policy Block

- MUST Index routes MUST use the _index.tsx suffix to indicate default route behavior within a segment
