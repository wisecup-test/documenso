# Adopt E2E API Testing for Frontend Rendering Model Validation: Tests Cover Versions
...
1. MUST: Tests MUST cover all API versions (v1, v2, tRPC) that serve data to frontend components to ensure version consistency

## Policy Block

- MUST Tests MUST cover all API versions (v1, v2, tRPC) that serve data to frontend components to ensure version consistency
