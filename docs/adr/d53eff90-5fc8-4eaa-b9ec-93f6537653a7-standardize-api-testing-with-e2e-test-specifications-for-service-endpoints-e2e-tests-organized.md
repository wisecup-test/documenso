# Standardize API Testing with E2E Test Specifications for Service Endpoints: E2e Tests Organized
...
1. MUST: E2E API tests MUST be organized by API version and protocol (v1, v2, trpc) in separate subdirectories

## Policy Block

- MUST E2E API tests MUST be organized by API version and protocol (v1, v2, trpc) in separate subdirectories
