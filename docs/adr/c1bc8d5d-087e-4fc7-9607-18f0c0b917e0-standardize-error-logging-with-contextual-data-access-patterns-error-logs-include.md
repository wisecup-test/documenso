# Standardize Error Logging with Contextual Data Access Patterns: Error Logs Include
...
1. MUST: Error logs MUST include sufficient context to identify the operation that failed, including operation type, relevant identifiers, and input parameters (sanitized of sensitive data)

## Policy Block

- MUST Error logs MUST include sufficient context to identify the operation that failed, including operation type, relevant identifiers, and input parameters (sanitized of sensitive data)
