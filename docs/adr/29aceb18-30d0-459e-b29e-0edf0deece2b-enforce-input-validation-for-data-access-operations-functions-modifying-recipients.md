# Enforce Input Validation for Data Access Operations: Functions Modifying Recipients
...
1. MUST: Functions modifying recipients, fields, or document properties MUST verify user authorization before processing input

## Policy Block

- MUST Functions modifying recipients, fields, or document properties MUST verify user authorization before processing input
