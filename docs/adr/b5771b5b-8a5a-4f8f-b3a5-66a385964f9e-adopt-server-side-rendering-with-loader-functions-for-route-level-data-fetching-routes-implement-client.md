# Adopt Server-Side Rendering with Loader Functions for Route-Level Data Fetching: Routes Implement Client
...
1. MAY: Routes MAY implement client-side data fetching for progressive enhancement or real-time updates after initial render

## Policy Block

- MAY Routes MAY implement client-side data fetching for progressive enhancement or real-time updates after initial render
