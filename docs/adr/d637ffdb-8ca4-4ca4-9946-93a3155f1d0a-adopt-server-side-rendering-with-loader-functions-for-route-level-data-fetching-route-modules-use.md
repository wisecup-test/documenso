# Adopt Server-Side Rendering with Loader Functions for Route-Level Data Fetching: Route Modules Use
...
1. SHOULD: Route modules SHOULD use TypeScript type inference from loader return types to ensure type safety in components

## Policy Block

- SHOULD Route modules SHOULD use TypeScript type inference from loader return types to ensure type safety in components
