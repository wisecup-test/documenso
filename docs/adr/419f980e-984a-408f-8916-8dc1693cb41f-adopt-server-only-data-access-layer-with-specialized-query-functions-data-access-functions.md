# Adopt Server-Only Data Access Layer with Specialized Query Functions: Data Access Functions
...
1. MAY: Data access functions MAY use query builders, ORMs, or raw SQL as appropriate for the operation complexity, but the choice MUST be consistent within an entity domain

## Policy Block

- MAY Data access functions MAY use query builders, ORMs, or raw SQL as appropriate for the operation complexity, but the choice MUST be consistent within an entity domain
