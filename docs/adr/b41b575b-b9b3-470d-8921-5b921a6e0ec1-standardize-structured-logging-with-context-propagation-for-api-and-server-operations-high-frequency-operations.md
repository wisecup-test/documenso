# Standardize Structured Logging with Context Propagation for API and Server Operations: High Frequency Operations
...
1. MAY: High-frequency operations MAY implement sampling or rate-limiting for logs to prevent log volume from impacting system performance

## Policy Block

- MAY High-frequency operations MAY implement sampling or rate-limiting for logs to prevent log volume from impacting system performance
