# Standardize tRPC Router Pattern for Primary Datastore Access: Complex Datastore Queries
...
1. SHOULD: Complex datastore queries SHOULD be abstracted into repository or service layer functions rather than embedded directly in router handlers

## Policy Block

- SHOULD Complex datastore queries SHOULD be abstracted into repository or service layer functions rather than embedded directly in router handlers
