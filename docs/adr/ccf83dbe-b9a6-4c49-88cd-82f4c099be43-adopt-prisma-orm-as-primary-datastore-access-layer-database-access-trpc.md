# Adopt Prisma ORM as Primary Datastore Access Layer: Database Access Trpc
...
1. MUST: All database access in tRPC routers MUST use Prisma Client as the primary ORM interface

## Policy Block

- MUST All database access in tRPC routers MUST use Prisma Client as the primary ORM interface
