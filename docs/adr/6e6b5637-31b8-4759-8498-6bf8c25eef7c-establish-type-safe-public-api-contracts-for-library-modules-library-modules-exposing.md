# Establish Type-Safe Public API Contracts for Library Modules: Library Modules Exposing
...
1. MUST: Library modules exposing public functionality MUST declare their public interface in a dedicated contract file (e.g., contract.ts)

## Policy Block

- MUST Library modules exposing public functionality MUST declare their public interface in a dedicated contract file (e.g., contract.ts)
