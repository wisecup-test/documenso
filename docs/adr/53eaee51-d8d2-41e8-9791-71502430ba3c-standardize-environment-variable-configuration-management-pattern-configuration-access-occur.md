# Standardize Environment Variable Configuration Management Pattern: Configuration Access Occur
...
1. MUST: Configuration access MUST occur through a dedicated configuration module or service that provides type-safe access to configuration values

## Policy Block

- MUST Configuration access MUST occur through a dedicated configuration module or service that provides type-safe access to configuration values
