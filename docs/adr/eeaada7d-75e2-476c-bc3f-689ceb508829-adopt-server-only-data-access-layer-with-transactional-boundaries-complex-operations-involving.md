# Adopt Server-Only Data Access Layer with Transactional Boundaries: Complex Operations Involving
...
1. SHOULD: Complex operations involving multiple entities SHOULD use database transactions to ensure atomicity and data consistency

## Policy Block

- SHOULD Complex operations involving multiple entities SHOULD use database transactions to ensure atomicity and data consistency
