# Standardize Error Logging with Contextual Data Access Patterns: Sensitive Data Passwords
...
1. SHOULD: Sensitive data (passwords, tokens, PII) SHOULD be sanitized or redacted from error logs before emission

## Policy Block

- SHOULD Sensitive data (passwords, tokens, PII) SHOULD be sanitized or redacted from error logs before emission
