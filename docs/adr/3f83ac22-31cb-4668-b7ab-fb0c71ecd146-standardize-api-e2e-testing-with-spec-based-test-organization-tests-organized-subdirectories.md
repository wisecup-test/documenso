# Standardize API E2E Testing with Spec-Based Test Organization: Tests Organized Subdirectories
...
1. MUST: Tests MUST be organized into subdirectories by API type: trpc/ for tRPC endpoints, v1/ for REST API v1, v2/ for REST API v2

## Policy Block

- MUST Tests MUST be organized into subdirectories by API type: trpc/ for tRPC endpoints, v1/ for REST API v1, v2/ for REST API v2
