# Adopt Server-Only Data Access Layer with Function-Based Repository Pattern: Data Access Functions
...
1. SHOULD: Data access functions SHOULD follow consistent naming conventions: get-* for single record retrieval, find-* for queries, update-* for modifications, delete-* or remove-* for deletions

## Policy Block

- SHOULD Data access functions SHOULD follow consistent naming conventions: get-* for single record retrieval, find-* for queries, update-* for modifications, delete-* or remove-* for deletions
