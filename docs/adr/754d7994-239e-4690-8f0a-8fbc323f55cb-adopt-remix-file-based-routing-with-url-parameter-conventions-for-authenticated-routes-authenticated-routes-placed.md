# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Authenticated Routes Placed
...
1. MUST: All authenticated routes MUST be placed within the _authenticated+ route segment to enforce authentication boundaries

## Policy Block

- MUST All authenticated routes MUST be placed within the _authenticated+ route segment to enforce authentication boundaries
