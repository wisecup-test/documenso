# Enforce Input Validation for Data Access Operations: Data Access Operations
...
1. MUST: Data access operations MUST sanitize string inputs to prevent injection attacks before constructing queries

## Policy Block

- MUST Data access operations MUST sanitize string inputs to prevent injection attacks before constructing queries
