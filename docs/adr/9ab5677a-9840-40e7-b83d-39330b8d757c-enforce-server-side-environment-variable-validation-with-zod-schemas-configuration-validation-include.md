# Enforce Server-Side Environment Variable Validation with Zod Schemas: Configuration Validation Include
...
1. MAY: Configuration validation MAY include transformation logic (e.g., parsing URLs, converting strings to numbers) as part of the schema definition

## Policy Block

- MAY Configuration validation MAY include transformation logic (e.g., parsing URLs, converting strings to numbers) as part of the schema definition
