...
1. SHOULD: Server-only modules SHOULD use framework-specific mechanisms (e.g., Remix loaders/actions, Next.js API routes) to expose functionality to client layers

## Policy Block

- SHOULD Server-only modules SHOULD use framework-specific mechanisms (e.g., Remix loaders/actions, Next.js API routes) to expose functionality to client layers
