# Enforce Server-Only Module Boundaries for Sensitive Operations: Data Access Patterns
...
1. MUST: Data access patterns and database operations MUST be encapsulated within server-only modules to prevent exposure of query logic and connection details

## Policy Block

- MUST Data access patterns and database operations MUST be encapsulated within server-only modules to prevent exposure of query logic and connection details
