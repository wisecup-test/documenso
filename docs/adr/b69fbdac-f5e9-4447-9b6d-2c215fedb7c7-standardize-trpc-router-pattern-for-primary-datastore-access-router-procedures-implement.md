# Standardize tRPC Router Pattern for Primary Datastore Access: Router Procedures Implement
...
1. MAY: Router procedures MAY implement caching strategies for frequently accessed datastore entities, provided cache invalidation is properly handled

## Policy Block

- MAY Router procedures MAY implement caching strategies for frequently accessed datastore entities, provided cache invalidation is properly handled
