# Adopt E2E API Testing for Frontend Rendering Model Validation: Endpoints That Provide
...
1. MUST: All API endpoints that provide data for frontend rendering MUST have corresponding E2E test specifications

## Policy Block

- MUST All API endpoints that provide data for frontend rendering MUST have corresponding E2E test specifications
