# Standardize Structured Logging with Context Propagation for API and Server Operations: Service Clients Making
...
1. MUST: Service clients making external calls MUST log request/response metadata including endpoint, status code, and duration

## Policy Block

- MUST Service clients making external calls MUST log request/response metadata including endpoint, status code, and duration
