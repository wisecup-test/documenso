# Establish Type-Safe Public API Contracts for Library Modules: Public Provide Openapi
...
1. SHOULD: Public APIs SHOULD provide OpenAPI/Swagger specifications for documentation and validation

## Policy Block

- SHOULD Public APIs SHOULD provide OpenAPI/Swagger specifications for documentation and validation
