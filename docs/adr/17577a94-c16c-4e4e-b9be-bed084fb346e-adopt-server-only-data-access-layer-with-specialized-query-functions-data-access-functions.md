...
1. SHOULD: Data access functions SHOULD be single-purpose and focused on one entity operation to maintain composability and testability

## Policy Block

- SHOULD Data access functions SHOULD be single-purpose and focused on one entity operation to maintain composability and testability
