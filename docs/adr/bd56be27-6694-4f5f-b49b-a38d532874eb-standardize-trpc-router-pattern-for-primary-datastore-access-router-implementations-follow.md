# Standardize tRPC Router Pattern for Primary Datastore Access: Router Implementations Follow
...
1. SHOULD: Router implementations SHOULD follow a consistent file structure pattern: router-name/entity/operation.ts (e.g., envelope-router/attachment/find-attachments.ts)

## Policy Block

- SHOULD Router implementations SHOULD follow a consistent file structure pattern: router-name/entity/operation.ts (e.g., envelope-router/attachment/find-attachments.ts)
