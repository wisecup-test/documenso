# Enforce Server-Only Code Isolation for Runtime Environment Boundaries: Build Tooling Configured
...
1. SHOULD: Build tooling SHOULD be configured to detect and fail on accidental client-side imports of server-only modules

## Policy Block

- SHOULD Build tooling SHOULD be configured to detect and fail on accidental client-side imports of server-only modules
