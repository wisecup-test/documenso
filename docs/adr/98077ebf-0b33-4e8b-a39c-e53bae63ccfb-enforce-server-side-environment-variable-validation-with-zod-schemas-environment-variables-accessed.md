# Enforce Server-Side Environment Variable Validation with Zod Schemas: Environment Variables Accessed
...
1. MUST: All environment variables accessed by server-side code MUST be validated using Zod schemas before use

## Policy Block

- MUST All environment variables accessed by server-side code MUST be validated using Zod schemas before use
