# Adopt Monorepo Package Structure with Scoped Modules: Packages Not Create
...
1. MUST_NOT: Packages MUST NOT create circular dependencies between each other

## Policy Block

- MUST_NOT Packages MUST NOT create circular dependencies between each other
