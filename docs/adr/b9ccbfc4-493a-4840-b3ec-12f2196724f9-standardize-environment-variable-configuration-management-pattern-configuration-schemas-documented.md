# Standardize Environment Variable Configuration Management Pattern: Configuration Schemas Documented
...
1. SHOULD: Configuration schemas SHOULD be documented and version-controlled to track changes in configuration requirements over time

## Policy Block

- SHOULD Configuration schemas SHOULD be documented and version-controlled to track changes in configuration requirements over time
