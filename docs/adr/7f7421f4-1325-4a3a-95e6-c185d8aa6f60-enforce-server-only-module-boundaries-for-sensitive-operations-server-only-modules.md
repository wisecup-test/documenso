...
1. SHOULD: Server-only modules SHOULD be organized in dedicated directories (e.g., /server-only/, /api/, /lib/server/) to provide clear visual separation

## Policy Block

- SHOULD Server-only modules SHOULD be organized in dedicated directories (e.g., /server-only/, /api/, /lib/server/) to provide clear visual separation
