# Implement Cache Layer for Public API Route Handlers: Cache Invalidation Occur
...
1. MUST: Cache invalidation MUST occur on any mutation operation that affects the cached data

## Policy Block

- MUST Cache invalidation MUST occur on any mutation operation that affects the cached data
