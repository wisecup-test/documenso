...
1. SHOULD: Configuration modules SHOULD provide default values for non-critical settings with clear documentation of the defaults

## Policy Block

- SHOULD Configuration modules SHOULD provide default values for non-critical settings with clear documentation of the defaults
