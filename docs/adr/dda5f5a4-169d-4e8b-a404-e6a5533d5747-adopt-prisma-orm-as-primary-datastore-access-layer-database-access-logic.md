# Adopt Prisma ORM as Primary Datastore Access Layer: Database Access Logic
...
1. SHOULD: Database access logic SHOULD be encapsulated in dedicated service functions or repository patterns rather than inline in router handlers

## Policy Block

- SHOULD Database access logic SHOULD be encapsulated in dedicated service functions or repository patterns rather than inline in router handlers
