# Enforce Server-Only Code Isolation for Runtime Environment Boundaries: Implementation Modules That
...
1. MUST: API implementation modules that expose server functionality MUST validate execution context and reject client-side invocations

## Policy Block

- MUST API implementation modules that expose server functionality MUST validate execution context and reject client-side invocations
