# Standardize Service Boundary Definitions Through Environment-Aware Configuration: Configuration Schemas Validated
...
1. SHOULD: Configuration schemas SHOULD be validated at application startup to fail fast on misconfiguration

## Policy Block

- SHOULD Configuration schemas SHOULD be validated at application startup to fail fast on misconfiguration
