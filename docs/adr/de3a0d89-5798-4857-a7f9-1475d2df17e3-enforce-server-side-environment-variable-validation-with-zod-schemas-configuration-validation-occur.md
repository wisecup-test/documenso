# Enforce Server-Side Environment Variable Validation with Zod Schemas: Configuration Validation Occur
...
1. MUST: Configuration validation MUST occur at module initialization or application startup, not at request time

## Policy Block

- MUST Configuration validation MUST occur at module initialization or application startup, not at request time
