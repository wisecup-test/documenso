# Standardize API E2E Testing with Spec-Based Test Organization: Test Files Follow
...
1. MUST: Test files MUST follow the naming convention {feature-name}.spec.ts for consistency and discoverability

## Policy Block

- MUST Test files MUST follow the naming convention {feature-name}.spec.ts for consistency and discoverability
