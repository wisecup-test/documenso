# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Route File Names
...
1. MUST: Route file names MUST use dot notation for nested path segments and plus signs (+) for layout boundaries

## Policy Block

- MUST Route file names MUST use dot notation for nested path segments and plus signs (+) for layout boundaries
