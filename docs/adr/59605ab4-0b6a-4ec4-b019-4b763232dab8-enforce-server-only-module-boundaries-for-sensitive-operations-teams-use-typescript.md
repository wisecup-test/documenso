# Enforce Server-Only Module Boundaries for Sensitive Operations: Teams Use Typescript
...
1. MAY: Teams MAY use TypeScript path aliases or module resolution configuration to enforce import restrictions at development time

## Policy Block

- MAY Teams MAY use TypeScript path aliases or module resolution configuration to enforce import restrictions at development time
