# Standardize Public API Route Structure and External Integration Patterns: Authentication Aware Routes
...
1. MUST: Authentication-aware routes MUST be grouped under the _authenticated+ namespace or equivalent authentication boundary

## Policy Block

- MUST Authentication-aware routes MUST be grouped under the _authenticated+ namespace or equivalent authentication boundary
