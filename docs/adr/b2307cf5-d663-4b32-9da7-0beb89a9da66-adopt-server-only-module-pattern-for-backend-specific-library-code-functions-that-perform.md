# Adopt Server-Only Module Pattern for Backend-Specific Library Code: Functions That Perform
...
1. SHOULD: Functions that perform authentication, authorization, or token validation SHOULD be implemented as server-only modules

## Policy Block

- SHOULD Functions that perform authentication, authorization, or token validation SHOULD be implemented as server-only modules
