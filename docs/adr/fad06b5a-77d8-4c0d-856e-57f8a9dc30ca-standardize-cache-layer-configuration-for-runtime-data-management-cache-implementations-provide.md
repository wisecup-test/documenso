# Standardize Cache Layer Configuration for Runtime Data Management: Cache Implementations Provide
...
1. SHOULD: Cache implementations SHOULD provide TTL (time-to-live) configuration per cache entry type to balance freshness and performance

## Policy Block

- SHOULD Cache implementations SHOULD provide TTL (time-to-live) configuration per cache entry type to balance freshness and performance
