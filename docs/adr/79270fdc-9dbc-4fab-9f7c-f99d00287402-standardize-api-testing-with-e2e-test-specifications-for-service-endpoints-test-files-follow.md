# Standardize API Testing with E2E Test Specifications for Service Endpoints: Test Files Follow
...
1. SHOULD: API test files SHOULD follow the naming convention {endpoint-name}.spec.ts to clearly identify the endpoint under test

## Policy Block

- SHOULD API test files SHOULD follow the naming convention {endpoint-name}.spec.ts to clearly identify the endpoint under test
