# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Organization Team Scoped
...
1. MUST: Organization and team-scoped endpoints MUST use URL parameters ($orgUrl, $teamUrl) for resource identification rather than query parameters

## Policy Block

- MUST Organization and team-scoped endpoints MUST use URL parameters ($orgUrl, $teamUrl) for resource identification rather than query parameters
