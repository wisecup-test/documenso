# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Settings Related Endpoints
...
1. SHOULD: Settings-related endpoints SHOULD follow the pattern o.$orgUrl.settings.{domain} for organizational settings and settings+/_dynamic_personal_routes+ for personal settings

## Policy Block

- SHOULD Settings-related endpoints SHOULD follow the pattern o.$orgUrl.settings.{domain} for organizational settings and settings+/_dynamic_personal_routes+ for personal settings
