# Adopt Monorepo Package Structure with Scoped Modules: Shared Code Organized
...
1. MUST: All shared code MUST be organized under the packages/ directory with clear package scoping (e.g., packages/api, packages/lib, packages/app-tests)

## Policy Block

- MUST All shared code MUST be organized under the packages/ directory with clear package scoping (e.g., packages/api, packages/lib, packages/app-tests)
