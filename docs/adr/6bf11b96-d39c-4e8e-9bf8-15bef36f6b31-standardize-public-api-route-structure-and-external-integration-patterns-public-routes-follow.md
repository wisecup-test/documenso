# Standardize Public API Route Structure and External Integration Patterns: Public Routes Follow
...
1. MUST: All public API routes MUST follow a consistent URL structure pattern with clear resource hierarchy (e.g., /o.$orgUrl/*, /t.$teamUrl/*, /settings/*)

## Policy Block

- MUST All public API routes MUST follow a consistent URL structure pattern with clear resource hierarchy (e.g., /o.$orgUrl/*, /t.$teamUrl/*, /settings/*)
