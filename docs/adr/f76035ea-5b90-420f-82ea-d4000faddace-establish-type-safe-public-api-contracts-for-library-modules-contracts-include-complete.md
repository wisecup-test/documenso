# Establish Type-Safe Public API Contracts for Library Modules: Contracts Include Complete
...
1. MUST: API contracts MUST include complete type definitions for request parameters, response bodies, and error responses

## Policy Block

- MUST API contracts MUST include complete type definitions for request parameters, response bodies, and error responses
