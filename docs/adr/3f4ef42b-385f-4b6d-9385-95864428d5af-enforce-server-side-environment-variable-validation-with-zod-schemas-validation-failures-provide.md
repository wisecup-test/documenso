# Enforce Server-Side Environment Variable Validation with Zod Schemas: Validation Failures Provide
...
1. SHOULD: Validation failures SHOULD provide clear error messages indicating which configuration parameter is invalid and why

## Policy Block

- SHOULD Validation failures SHOULD provide clear error messages indicating which configuration parameter is invalid and why
