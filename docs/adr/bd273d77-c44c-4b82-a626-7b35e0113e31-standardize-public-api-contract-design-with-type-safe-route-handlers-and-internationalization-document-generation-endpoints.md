# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Document Generation Endpoints
...
1. MUST: Document generation endpoints (PDF, certificates, audit logs) MUST implement server-side rendering with appropriate Content-Type headers

## Policy Block

- MUST Document generation endpoints (PDF, certificates, audit logs) MUST implement server-side rendering with appropriate Content-Type headers
