# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Routes Use Nested
...
1. MAY: Routes MAY use nested folder structures with + suffix to create layout boundaries that share common UI components

## Policy Block

- MAY Routes MAY use nested folder structures with + suffix to create layout boundaries that share common UI components
