# Adopt E2E API Testing for Frontend Rendering Model Validation: E2e Tests Organized
...
1. SHOULD: E2E tests SHOULD be organized by API endpoint and version in a structured directory hierarchy (e.g., e2e/api/v2/, e2e/api/trpc/)

## Policy Block

- SHOULD E2E tests SHOULD be organized by API endpoint and version in a structured directory hierarchy (e.g., e2e/api/v2/, e2e/api/trpc/)
