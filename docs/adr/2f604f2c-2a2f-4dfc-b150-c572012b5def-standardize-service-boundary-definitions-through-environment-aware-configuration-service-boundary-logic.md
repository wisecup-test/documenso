# Standardize Service Boundary Definitions Through Environment-Aware Configuration: Service Boundary Logic
...
1. MUST_NOT: Service boundary logic MUST NOT contain environment-specific conditionals (if/else based on NODE_ENV) for defining endpoints or dependencies

## Policy Block

- MUST_NOT Service boundary logic MUST NOT contain environment-specific conditionals (if/else based on NODE_ENV) for defining endpoints or dependencies
