# Adopt Monorepo Package Structure with Scoped Modules: Contracts Openapi Specifications
...
1. MUST: API contracts and OpenAPI specifications MUST reside in packages/api with versioned subdirectories (e.g., v1/)

## Policy Block

- MUST API contracts and OpenAPI specifications MUST reside in packages/api with versioned subdirectories (e.g., v1/)
