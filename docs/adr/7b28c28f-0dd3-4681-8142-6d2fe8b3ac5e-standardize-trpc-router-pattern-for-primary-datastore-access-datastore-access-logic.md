# Standardize tRPC Router Pattern for Primary Datastore Access: Datastore Access Logic
...
1. MUST: Datastore access logic within tRPC routers MUST be encapsulated in dedicated handler functions or service layer methods, not inline within router definitions

## Policy Block

- MUST Datastore access logic within tRPC routers MUST be encapsulated in dedicated handler functions or service layer methods, not inline within router definitions
