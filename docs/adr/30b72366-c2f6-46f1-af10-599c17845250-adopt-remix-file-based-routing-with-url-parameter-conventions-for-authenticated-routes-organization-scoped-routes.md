# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Organization Scoped Routes
...
1. MUST: Organization-scoped routes MUST use the $orgUrl dynamic parameter pattern (e.g., o.$orgUrl.settings.members.tsx)

## Policy Block

- MUST Organization-scoped routes MUST use the $orgUrl dynamic parameter pattern (e.g., o.$orgUrl.settings.members.tsx)
