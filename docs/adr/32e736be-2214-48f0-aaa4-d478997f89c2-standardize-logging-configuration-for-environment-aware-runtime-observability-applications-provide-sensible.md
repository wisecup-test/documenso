# Standardize Logging Configuration for Environment-Aware Runtime Observability: Applications Provide Sensible
...
1. SHOULD: Applications SHOULD provide sensible default logging configurations that work without explicit environment variable settings

## Policy Block

- SHOULD Applications SHOULD provide sensible default logging configurations that work without explicit environment variable settings
