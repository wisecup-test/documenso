# Standardize Public API Route Structure and External Integration Patterns: Multi Tenant Routes
...
1. SHOULD: Multi-tenant routes SHOULD use URL parameters for tenant identification (orgUrl, teamUrl) rather than headers or query strings

## Policy Block

- SHOULD Multi-tenant routes SHOULD use URL parameters for tenant identification (orgUrl, teamUrl) rather than headers or query strings
