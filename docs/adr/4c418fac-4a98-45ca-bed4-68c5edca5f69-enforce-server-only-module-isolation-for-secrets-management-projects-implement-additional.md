# Enforce Server-Only Module Isolation for Secrets Management: Projects Implement Additional
...
1. MAY: Projects MAY implement additional runtime checks to verify server context when accessing sensitive configuration

## Policy Block

- MAY Projects MAY implement additional runtime checks to verify server context when accessing sensitive configuration
