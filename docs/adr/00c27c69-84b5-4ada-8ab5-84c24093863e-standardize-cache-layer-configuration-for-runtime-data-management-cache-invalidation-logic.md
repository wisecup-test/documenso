# Standardize Cache Layer Configuration for Runtime Data Management: Cache Invalidation Logic
...
1. MUST: Cache invalidation logic MUST be co-located with mutation operations to maintain data consistency

## Policy Block

- MUST Cache invalidation logic MUST be co-located with mutation operations to maintain data consistency
