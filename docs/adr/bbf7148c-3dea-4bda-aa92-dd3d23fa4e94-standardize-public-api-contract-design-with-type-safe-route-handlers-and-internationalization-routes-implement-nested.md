# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Routes Implement Nested
...
1. MAY: API routes MAY implement nested layouts (_layout.tsx) for shared authentication, authorization, and data loading logic

## Policy Block

- MAY API routes MAY implement nested layouts (_layout.tsx) for shared authentication, authorization, and data loading logic
