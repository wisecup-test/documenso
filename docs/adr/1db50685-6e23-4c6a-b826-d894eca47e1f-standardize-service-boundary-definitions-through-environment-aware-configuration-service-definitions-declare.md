# Standardize Service Boundary Definitions Through Environment-Aware Configuration: Service Definitions Declare
...
1. MUST: Service definitions MUST declare their external dependencies, API endpoints, and integration points through configuration

## Policy Block

- MUST Service definitions MUST declare their external dependencies, API endpoints, and integration points through configuration
