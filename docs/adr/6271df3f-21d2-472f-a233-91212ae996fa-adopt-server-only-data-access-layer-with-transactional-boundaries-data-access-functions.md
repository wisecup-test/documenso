...
1. SHOULD: Data access functions SHOULD be organized by domain entity (e.g., folder/, recipient/, profile/, public-api/) to maintain clear module boundaries

## Policy Block

- SHOULD Data access functions SHOULD be organized by domain entity (e.g., folder/, recipient/, profile/, public-api/) to maintain clear module boundaries
