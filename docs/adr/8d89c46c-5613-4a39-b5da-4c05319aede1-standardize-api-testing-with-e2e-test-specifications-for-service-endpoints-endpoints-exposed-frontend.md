# Standardize API Testing with E2E Test Specifications for Service Endpoints: Endpoints Exposed Frontend
...
1. MUST: All API endpoints exposed to frontend rendering components MUST have corresponding E2E test specifications in the packages/app-tests/e2e/api directory

## Policy Block

- MUST All API endpoints exposed to frontend rendering components MUST have corresponding E2E test specifications in the packages/app-tests/e2e/api directory
