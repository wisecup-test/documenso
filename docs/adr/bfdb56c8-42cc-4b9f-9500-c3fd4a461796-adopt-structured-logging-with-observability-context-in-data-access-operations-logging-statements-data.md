# Adopt Structured Logging with Observability Context in Data Access Operations: Logging Statements Data
...
1. MUST: Logging statements in data access layers MUST use structured log formats (JSON or key-value pairs) rather than unstructured string concatenation

## Policy Block

- MUST Logging statements in data access layers MUST use structured log formats (JSON or key-value pairs) rather than unstructured string concatenation
