...
1. MUST: Server-only modules MUST include runtime guards or build-time checks that prevent execution or bundling in client environments

## Policy Block

- MUST Server-only modules MUST include runtime guards or build-time checks that prevent execution or bundling in client environments
