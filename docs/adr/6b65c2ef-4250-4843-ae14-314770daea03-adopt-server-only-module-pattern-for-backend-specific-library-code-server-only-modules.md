...
1. MUST_NOT: Server-only modules MUST NOT be imported directly by client-side components or pages

## Policy Block

- MUST_NOT Server-only modules MUST NOT be imported directly by client-side components or pages
