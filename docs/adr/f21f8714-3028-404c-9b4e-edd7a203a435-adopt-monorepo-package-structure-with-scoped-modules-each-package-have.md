# Adopt Monorepo Package Structure with Scoped Modules: Each Package Have
...
1. SHOULD: Each package SHOULD have a clear single responsibility (API contracts, server utilities, test fixtures, etc.)

## Policy Block

- SHOULD Each package SHOULD have a clear single responsibility (API contracts, server utilities, test fixtures, etc.)
