...
1. MAY: Server-only modules MAY export TypeScript types that can be safely imported by client code for type checking purposes

## Policy Block

- MAY Server-only modules MAY export TypeScript types that can be safely imported by client code for type checking purposes
