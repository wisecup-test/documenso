# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Team Scoped Routes
...
1. MUST: Team-scoped routes MUST use the $teamUrl dynamic parameter pattern within the t.$teamUrl+ segment (e.g., t.$teamUrl+/settings.members.tsx)

## Policy Block

- MUST Team-scoped routes MUST use the $teamUrl dynamic parameter pattern within the t.$teamUrl+ segment (e.g., t.$teamUrl+/settings.members.tsx)
