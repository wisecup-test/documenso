# Adopt Server-Side Rendering with Loader Functions for Route-Level Data Fetching: Route Components Not
...
1. MUST_NOT: Route components MUST NOT fetch initial page data using client-side API calls when loader functions can be used

## Policy Block

- MUST_NOT Route components MUST NOT fetch initial page data using client-side API calls when loader functions can be used
