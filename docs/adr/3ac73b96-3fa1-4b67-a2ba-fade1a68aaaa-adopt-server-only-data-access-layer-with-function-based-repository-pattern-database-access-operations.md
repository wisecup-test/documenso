# Adopt Server-Only Data Access Layer with Function-Based Repository Pattern: Database Access Operations
...
1. MUST: All database access operations MUST be implemented in the server-only directory structure and marked with server-only module boundaries

## Policy Block

- MUST All database access operations MUST be implemented in the server-only directory structure and marked with server-only module boundaries
