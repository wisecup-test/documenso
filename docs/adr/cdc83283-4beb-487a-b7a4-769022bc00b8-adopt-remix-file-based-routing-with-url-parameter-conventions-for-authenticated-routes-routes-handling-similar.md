# Adopt Remix File-Based Routing with URL Parameter Conventions for Authenticated Routes: Routes Handling Similar
...
1. SHOULD: Routes handling similar resources across different contexts (org vs team) SHOULD maintain parallel naming structures for consistency

## Policy Block

- SHOULD Routes handling similar resources across different contexts (org vs team) SHOULD maintain parallel naming structures for consistency
