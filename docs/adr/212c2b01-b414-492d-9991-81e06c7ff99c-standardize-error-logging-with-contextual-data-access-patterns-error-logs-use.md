# Standardize Error Logging with Contextual Data Access Patterns: Error Logs Use
...
1. SHOULD: Error logs SHOULD use structured logging formats that enable automated parsing and aggregation in observability platforms

## Policy Block

- SHOULD Error logs SHOULD use structured logging formats that enable automated parsing and aggregation in observability platforms
