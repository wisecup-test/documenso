# Standardize API Testing with E2E Test Specifications for Service Endpoints: Tests Service Boundaries
...
1. MUST: Tests for service boundaries MUST verify data contracts and type safety between frontend and backend

## Policy Block

- MUST Tests for service boundaries MUST verify data contracts and type safety between frontend and backend
