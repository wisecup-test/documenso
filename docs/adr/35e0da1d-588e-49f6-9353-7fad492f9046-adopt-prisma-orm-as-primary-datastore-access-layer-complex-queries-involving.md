# Adopt Prisma ORM as Primary Datastore Access Layer: Complex Queries Involving
...
1. SHOULD: Complex queries involving multiple relations SHOULD use Prisma's include and select options rather than multiple separate queries

## Policy Block

- SHOULD Complex queries involving multiple relations SHOULD use Prisma's include and select options rather than multiple separate queries
