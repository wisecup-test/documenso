# Adopt Prisma ORM as Primary Datastore Access Layer: Performance Critical Queries
...
1. MAY: Performance-critical queries MAY use Prisma's raw query methods ($queryRaw, $executeRaw) with proper type annotations when benchmarking demonstrates significant performance gains

## Policy Block

- MAY Performance-critical queries MAY use Prisma's raw query methods ($queryRaw, $executeRaw) with proper type annotations when benchmarking demonstrates significant performance gains
