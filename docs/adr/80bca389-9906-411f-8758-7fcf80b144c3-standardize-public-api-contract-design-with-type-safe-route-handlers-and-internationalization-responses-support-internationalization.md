# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Responses Support Internationalization
...
1. MUST: All API responses MUST support internationalization through Lingui configuration with locale-aware content

## Policy Block

- MUST All API responses MUST support internationalization through Lingui configuration with locale-aware content
