# Enforce Input Validation for Data Access Operations: Validation Failures Return
...
1. SHOULD: Validation failures SHOULD return descriptive error messages that do not expose internal system details

## Policy Block

- SHOULD Validation failures SHOULD return descriptive error messages that do not expose internal system details
