# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Public Endpoints Not
...
1. MUST_NOT: Public API endpoints MUST_NOT expose unauthenticated routes for organizational or personal data without explicit security review

## Policy Block

- MUST_NOT Public API endpoints MUST_NOT expose unauthenticated routes for organizational or personal data without explicit security review
