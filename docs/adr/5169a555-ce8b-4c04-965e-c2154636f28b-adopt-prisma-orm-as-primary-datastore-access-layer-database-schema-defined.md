# Adopt Prisma ORM as Primary Datastore Access Layer: Database Schema Defined
...
1. MUST: Database schema MUST be defined in a centralized Prisma schema file (schema.prisma) as the single source of truth

## Policy Block

- MUST Database schema MUST be defined in a centralized Prisma schema file (schema.prisma) as the single source of truth
