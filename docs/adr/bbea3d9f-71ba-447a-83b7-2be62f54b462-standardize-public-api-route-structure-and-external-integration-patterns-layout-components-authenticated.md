# Standardize Public API Route Structure and External Integration Patterns: Layout Components Authenticated
...
1. SHOULD: Layout components for authenticated sections SHOULD be colocated with their routes using _layout.tsx convention

## Policy Block

- SHOULD Layout components for authenticated sections SHOULD be colocated with their routes using _layout.tsx convention
