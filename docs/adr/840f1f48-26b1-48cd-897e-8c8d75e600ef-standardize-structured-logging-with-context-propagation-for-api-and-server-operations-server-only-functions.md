# Standardize Structured Logging with Context Propagation for API and Server Operations: Server Only Functions
...
1. MUST: Server-only functions performing business operations MUST log operation start, completion, and any errors with relevant entity identifiers

## Policy Block

- MUST Server-only functions performing business operations MUST log operation start, completion, and any errors with relevant entity identifiers
