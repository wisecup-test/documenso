# Adopt Server-Side Rendering with Loader Functions for Route-Level Data Fetching: Route Modules Export
...
1. MUST: All route modules MUST export a loader function when server-side data is required for initial render

## Policy Block

- MUST All route modules MUST export a loader function when server-side data is required for initial render
