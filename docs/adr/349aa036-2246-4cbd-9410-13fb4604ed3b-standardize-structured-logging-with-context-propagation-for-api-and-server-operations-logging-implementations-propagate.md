# Standardize Structured Logging with Context Propagation for API and Server Operations: Logging Implementations Propagate
...
1. SHOULD: Logging implementations SHOULD propagate correlation IDs across service boundaries to enable distributed tracing

## Policy Block

- SHOULD Logging implementations SHOULD propagate correlation IDs across service boundaries to enable distributed tracing
