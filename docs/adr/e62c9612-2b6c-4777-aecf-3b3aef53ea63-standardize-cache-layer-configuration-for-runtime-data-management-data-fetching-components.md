# Standardize Cache Layer Configuration for Runtime Data Management: Data Fetching Components
...
1. MUST: All data-fetching components (route handlers, API utilities, tRPC handlers) MUST declare cache configuration explicitly rather than relying on implicit defaults

## Policy Block

- MUST All data-fetching components (route handlers, API utilities, tRPC handlers) MUST declare cache configuration explicitly rather than relying on implicit defaults
