# Adopt Server-Side Rendering with Loader Functions for Route-Level Data Fetching: Loader Functions Handle
...
1. SHOULD: Loader functions SHOULD handle authentication, authorization, and data validation on the server before returning data

## Policy Block

- SHOULD Loader functions SHOULD handle authentication, authorization, and data validation on the server before returning data
