# Enforce Server-Side Environment Variable Validation with Zod Schemas: Code Not Access
...
1. MUST_NOT: Code MUST NOT access process.env directly without prior validation through a typed configuration object

## Policy Block

- MUST_NOT Code MUST NOT access process.env directly without prior validation through a typed configuration object
