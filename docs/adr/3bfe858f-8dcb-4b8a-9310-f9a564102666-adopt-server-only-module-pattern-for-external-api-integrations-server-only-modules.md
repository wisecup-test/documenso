...
1. MUST_NOT: Server-only modules MUST NOT be imported or referenced directly from client-side code or components that execute in browser contexts

## Policy Block

- MUST_NOT Server-only modules MUST NOT be imported or referenced directly from client-side code or components that execute in browser contexts
