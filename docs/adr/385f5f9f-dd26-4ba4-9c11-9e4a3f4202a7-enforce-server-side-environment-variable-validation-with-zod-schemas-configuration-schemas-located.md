# Enforce Server-Side Environment Variable Validation with Zod Schemas: Configuration Schemas Located
...
1. SHOULD: Configuration schemas SHOULD be co-located with the modules that consume them or centralized in a configuration module

## Policy Block

- SHOULD Configuration schemas SHOULD be co-located with the modules that consume them or centralized in a configuration module
