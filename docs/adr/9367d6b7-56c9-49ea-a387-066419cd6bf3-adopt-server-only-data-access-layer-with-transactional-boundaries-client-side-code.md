# Adopt Server-Only Data Access Layer with Transactional Boundaries: Client Side Code
...
1. MUST_NOT: Client-side code MUST NOT import or execute database queries directly; all data access MUST be mediated through server-only API endpoints

## Policy Block

- MUST_NOT Client-side code MUST NOT import or execute database queries directly; all data access MUST be mediated through server-only API endpoints
