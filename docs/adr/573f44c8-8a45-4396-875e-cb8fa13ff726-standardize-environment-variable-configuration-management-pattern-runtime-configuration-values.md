# Standardize Environment Variable Configuration Management Pattern: Runtime Configuration Values
...
1. MUST: All runtime configuration values MUST be sourced from environment variables or a centralized configuration management system, never hardcoded in application logic

## Policy Block

- MUST All runtime configuration values MUST be sourced from environment variables or a centralized configuration management system, never hardcoded in application logic
