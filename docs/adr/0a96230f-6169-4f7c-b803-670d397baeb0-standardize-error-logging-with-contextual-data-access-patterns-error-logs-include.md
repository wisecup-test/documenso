...
1. MAY: Error logs MAY include additional diagnostic information such as stack traces, timing data, or correlation IDs to aid in debugging

## Policy Block

- MAY Error logs MAY include additional diagnostic information such as stack traces, timing data, or correlation IDs to aid in debugging
