# Standardize Structured Logging with Context Propagation for API and Server Operations: Log Entries Use
...
1. MUST: Log entries MUST use structured formats (JSON) rather than plain text to enable automated parsing and analysis

## Policy Block

- MUST Log entries MUST use structured formats (JSON) rather than plain text to enable automated parsing and analysis
