# Establish Type-Safe Public API Contracts for Library Modules: Packages Use Constants
...
1. MAY: Packages MAY use constants files to define shared metadata and configuration for API contracts

## Policy Block

- MAY Packages MAY use constants files to define shared metadata and configuration for API contracts
