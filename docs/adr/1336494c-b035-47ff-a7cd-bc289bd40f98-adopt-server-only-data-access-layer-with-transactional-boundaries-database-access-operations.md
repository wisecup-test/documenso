# Adopt Server-Only Data Access Layer with Transactional Boundaries: Database Access Operations
...
1. MUST: All database access operations MUST be implemented in the server-only layer and MUST NOT be directly accessible from client-side code

## Policy Block

- MUST All database access operations MUST be implemented in the server-only layer and MUST NOT be directly accessible from client-side code
