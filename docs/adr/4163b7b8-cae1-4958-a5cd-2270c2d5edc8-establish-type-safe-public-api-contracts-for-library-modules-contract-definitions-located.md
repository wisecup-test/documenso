# Establish Type-Safe Public API Contracts for Library Modules: Contract Definitions Located
...
1. SHOULD: Contract definitions SHOULD be co-located with their implementation within the same package structure

## Policy Block

- SHOULD Contract definitions SHOULD be co-located with their implementation within the same package structure
