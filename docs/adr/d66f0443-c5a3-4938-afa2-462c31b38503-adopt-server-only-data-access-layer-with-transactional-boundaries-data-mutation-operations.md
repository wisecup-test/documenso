# Adopt Server-Only Data Access Layer with Transactional Boundaries: Data Mutation Operations
...
1. MUST: Data mutation operations (create, update, delete) MUST be encapsulated in dedicated service functions with clear transactional boundaries

## Policy Block

- MUST Data mutation operations (create, update, delete) MUST be encapsulated in dedicated service functions with clear transactional boundaries
