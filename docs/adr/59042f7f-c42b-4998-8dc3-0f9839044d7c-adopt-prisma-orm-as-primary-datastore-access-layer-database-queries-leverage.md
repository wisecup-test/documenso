# Adopt Prisma ORM as Primary Datastore Access Layer: Database Queries Leverage
...
1. MUST: Database queries MUST leverage Prisma's type-safe query builder rather than raw SQL strings

## Policy Block

- MUST Database queries MUST leverage Prisma's type-safe query builder rather than raw SQL strings
