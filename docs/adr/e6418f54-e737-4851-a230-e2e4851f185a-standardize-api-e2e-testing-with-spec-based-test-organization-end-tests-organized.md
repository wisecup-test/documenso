# Standardize API E2E Testing with Spec-Based Test Organization: End Tests Organized
...
1. MUST: All API end-to-end tests MUST be organized under packages/app-tests/e2e/api/ directory structure

## Policy Block

- MUST All API end-to-end tests MUST be organized under packages/app-tests/e2e/api/ directory structure
