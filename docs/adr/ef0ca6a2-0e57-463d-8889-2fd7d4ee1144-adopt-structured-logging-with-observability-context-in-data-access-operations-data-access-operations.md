# Adopt Structured Logging with Observability Context in Data Access Operations: Data Access Operations
...
1. MUST: All data access operations in server-only modules MUST implement structured logging with contextual information including operation type, entity identifiers, and timing data

## Policy Block

- MUST All data access operations in server-only modules MUST implement structured logging with contextual information including operation type, entity identifiers, and timing data
