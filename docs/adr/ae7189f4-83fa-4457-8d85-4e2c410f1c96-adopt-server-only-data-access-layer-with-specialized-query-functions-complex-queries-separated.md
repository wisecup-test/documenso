# Adopt Server-Only Data Access Layer with Specialized Query Functions: Complex Queries Separated
...
1. SHOULD: Complex queries SHOULD be separated into internal and external variants (e.g., find-folders.ts and find-folders-internal.ts) where internal variants bypass certain validations for trusted system operations

## Policy Block

- SHOULD Complex queries SHOULD be separated into internal and external variants (e.g., find-folders.ts and find-folders-internal.ts) where internal variants bypass certain validations for trusted system operations
