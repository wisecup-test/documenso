# Adopt Server-Only Data Access Layer with Transactional Boundaries: Each Data Access
...
1. MUST: Each data access function MUST handle a single, well-defined business operation with explicit input validation and error handling

## Policy Block

- MUST Each data access function MUST handle a single, well-defined business operation with explicit input validation and error handling
