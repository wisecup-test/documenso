# Standardize Logging Configuration for Environment-Aware Runtime Observability: Log Output Format
...
1. MUST: Log output format and destination MUST be configurable through environment-specific settings

## Policy Block

- MUST Log output format and destination MUST be configurable through environment-specific settings
