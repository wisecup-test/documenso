# Standardize Public API Contract Design with Type-Safe Route Handlers and Internationalization: Route Handlers Use
...
1. SHOULD: API route handlers SHOULD use TypeScript with explicit type definitions for loader and action functions

## Policy Block

- SHOULD API route handlers SHOULD use TypeScript with explicit type definitions for loader and action functions
