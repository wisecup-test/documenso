# Standardize Structured Logging with Context Propagation for API and Server Operations: Error Logs Include
...
1. SHOULD: Error logs SHOULD include stack traces and contextual data sufficient for debugging without requiring log aggregation from multiple sources

## Policy Block

- SHOULD Error logs SHOULD include stack traces and contextual data sufficient for debugging without requiring log aggregation from multiple sources
