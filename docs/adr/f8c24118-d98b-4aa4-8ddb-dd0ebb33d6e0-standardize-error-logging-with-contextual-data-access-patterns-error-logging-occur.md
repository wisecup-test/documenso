# Standardize Error Logging with Contextual Data Access Patterns: Error Logging Occur
...
1. MUST: Error logging MUST occur at the boundary where the error is first caught, before re-throwing or transforming the error

## Policy Block

- MUST Error logging MUST occur at the boundary where the error is first caught, before re-throwing or transforming the error
