# Adopt Prisma ORM as Primary Datastore Access Layer: Router Implementations Not
...
1. MUST_NOT: Router implementations MUST NOT bypass Prisma Client to execute direct database connections for standard CRUD operations

## Policy Block

- MUST_NOT Router implementations MUST NOT bypass Prisma Client to execute direct database connections for standard CRUD operations
