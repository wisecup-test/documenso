# Adopt Server-Only Data Access Layer with Function-Based Repository Pattern: Each Data Access
...
1. MUST: Each data access function MUST be isolated in its own file with a single responsibility corresponding to one database operation

## Policy Block

- MUST Each data access function MUST be isolated in its own file with a single responsibility corresponding to one database operation
