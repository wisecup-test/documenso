# Adopt Server-Only Data Access Layer with Function-Based Repository Pattern: Internal Variants Data
...
1. MAY: Internal variants of data access functions (e.g., find-folders-internal) MAY be created for operations requiring different authorization contexts or additional internal parameters

## Policy Block

- MAY Internal variants of data access functions (e.g., find-folders-internal) MAY be created for operations requiring different authorization contexts or additional internal parameters
