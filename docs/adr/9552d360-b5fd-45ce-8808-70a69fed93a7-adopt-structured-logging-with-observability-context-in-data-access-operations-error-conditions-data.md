# Adopt Structured Logging with Observability Context in Data Access Operations: Error Conditions Data
...
1. SHOULD: Error conditions in data access operations SHOULD be logged with ERROR level and include stack traces and contextual state

## Policy Block

- SHOULD Error conditions in data access operations SHOULD be logged with ERROR level and include stack traces and contextual state
