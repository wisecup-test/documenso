# Standardize Public API Route Structure and External Integration Patterns: Configuration Files External
...
1. SHOULD: Configuration files for external integrations (i18n, API clients) SHOULD be centralized at the project root for discoverability

## Policy Block

- SHOULD Configuration files for external integrations (i18n, API clients) SHOULD be centralized at the project root for discoverability
