<rule_activation id="4f8ec1b0-e9b7-423c-8a85-6c6ca8f74ba0" title="Standardize tRPC Router Pattern for Primary Datastore Access: Router Procedures Handle" applies_to="**/*">
...
- **R-TRPC-001** MUST: Router procedures MUST handle datastore errors consistently and return appropriate tRPC error codes (NOT_FOUND, INTERNAL_SERVER_ERROR, etc.)
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All tRPC router implementations MUST be checked against R-TRPC-001 before acceptance. Violations block pull requests until refactored or approved exceptions are documented.
</enforcement>