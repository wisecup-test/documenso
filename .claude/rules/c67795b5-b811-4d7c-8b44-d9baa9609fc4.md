<rule_activation id="c67795b5-b811-4d7c-8b44-d9baa9609fc4" title="Adopt Server-Only Data Access Layer with Transactional Boundaries: Server Only Data" applies_to="**/*">
...
- **R-SODAL-001** MUST: Server-only data access modules MUST enforce authentication and authorization checks before executing database operations.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All database access patterns MUST be validated against the server-only layer architecture before proceeding with implementation.
</enforcement>