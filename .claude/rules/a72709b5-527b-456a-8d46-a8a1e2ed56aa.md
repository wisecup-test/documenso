<rule_activation id="a72709b5-527b-456a-8d46-a8a1e2ed56aa" title="Adopt Prisma ORM as Primary Datastore Access Layer: Performance Critical Queries" applies_to="**/*">
...
- **R-PRISMA-001** MAY: Performance-critical queries MAY use Prisma's raw query methods ($queryRaw, $executeRaw) with proper type annotations when benchmarking demonstrates significant performance gains.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All database access patterns MUST use Prisma Client unless an approved exception (EXC-001 or EXC-002) is documented.
</enforcement>